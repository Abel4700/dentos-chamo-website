export const About = () => {
  return `
  <div class="app-section about-root">
        ...
        <div class="hero-editorial-content-v3 fade-in-up">
          ...
          <div class="hero-metrics-v3">
            <div class="metric-item-v3">
              <div class="metric-number accent-text">9+</div>
              <div class="metric-label">Years of Legacy</div>
            </div>
            <div class="metric-divider"></div>
            <div class="metric-item-v3">
              <div class="metric-number accent-text">4+</div>
              <div class="metric-label">Specialized Divisions</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- 🏛️ FOUNDER NARRATIVE: CINEMATIC DARK -->
    <section class="section founder-cinematic">
      <div class="container">
        <div class="founder-grid-v3">
          <div class="founder-image-wrapper-v3 fade-in">
            ...
            <div class="floating-quote-v3 glass-card-v3 bounce-anim">
              <i class="fas fa-quote-left accent-text"></i>
              <p>"Our commitment has always been uncompromising quality—whether supplying advanced endodontics or exporting premium organic sesame."</p>
              <div class="quote-signature">
                <span class="sig-name accent-text">Dr. Aklilu Berhanu</span>
                <span class="sig-title">Founder & CEO</span>
              </div>
            </div>
          </div>
    ...
    <section class="section mission-section-v3">
      <div class="container">
        ...
        <div class="mission-bento-grid">
          <!-- Medical Mission -->
          <div class="mission-v3-item bento-v3-large glass-card-v3 hover-lift group-medical">
          ...
          <!-- Organic Mission -->
          <div class="mission-v3-item bento-v3-large glass-card-v3 hover-lift group-organic">
            <div class="bento-bg" style="background-image: url('https://images.unsplash.com/photo-1500651230702-0e2d8a49d4ad?auto=format&fit=crop&q=80&w=1200');"></div>
            <div class="mission-v3-content">
    ...
    <!-- 🧬 MASTER TIMELINE: THE JOURNEY -->
    <section class="section timeline-cinematic">
      <div class="container">
        <div class="section-header-centered mb-80 fade-in">
           <div class="hero-badge-v3">THE JOURNEY</div>
           <h2 class="section-title-visionary text-center">Corporate <span class="accent-text">Milestones</span></h2>
        </div>
        
        <div class="master-timeline-v3">
          <div class="timeline-v3-item fade-in">
            <div class="timeline-v3-dot-container">
               <div class="timeline-v3-pulse"></div>
               <div class="timeline-v3-dot"></div>
            </div>
          ...
          <div class="timeline-v3-item fade-in" style="animation-delay: 0.1s;">
            ...
            <div class="timeline-v3-content glass-card-v3 hover-lift">
              <div class="timeline-v3-date accent-text">Expansion</div>
              <h3>Agricultural Hub Launch</h3>
              <p>Establishing our organic export division focusing on premium sesame and oil crops for global fulfillment.</p>
            </div>
          </div>
          <div class="timeline-v3-item fade-in" style="animation-delay: 0.2s;">
            <div class="timeline-v3-dot-container">
               <div class="timeline-v3-pulse"></div>
               <div class="timeline-v3-dot"></div>
            </div>
    ...
    <section class="section team-master">
      <div class="container">
        ...
        <div class="team-grid-v3">
          ...
          <div class="team-card-v3 glass-card-v3 hover-lift fade-in" style="animation-delay: 0.3s;">
            <div class="team-portrait-wrapper-v3">
               <img src="/assets/yohannes_nega_1.jpeg" alt="Yohannes Nega" class="img-portrait-v3">
            </div>
            <div class="team-content-v3">
               <h3>Yohannes Nega</h3>
    ...
    <style>
      :root {
        ...
        --about-secondary: var(--secondary);
        --about-bg: var(--bg-light);
        --about-border: var(--glass-border);
      }

      .about-root { background-color: var(--about-bg); color: var(--text-main); width: 100%; position: relative; overflow-x: clip; }
      .accent-text { color: var(--about-secondary); }
      
      /* GLOBAL BACKGROUND (CLEAN CLINICAL) */
      .global-background-orbs { position: fixed; top:0; left:0; width:100%; height:100%; pointer-events:none; z-index:0; }
      .glass-orb { position: absolute; border-radius: 50%; filter: blur(120px); opacity: 0.05; animation: orbMove 30s infinite alternate ease-in-out; }
      .orb-primary { width: 600px; height: 600px; background: var(--about-primary); top: -100px; right: -150px; }
      .orb-accent { width: 450px; height: 450px; background: var(--about-secondary); bottom: 100px; left: -100px; animation-delay: -7s; }
      @keyframes orbMove { from { transform: translate(0,0); } to { transform: translate(200px, 150px); } }

      /* HERO EDITORIAL V3 (CINEMATIC DARK OVERLAY) */
      .hero-editorial-v3 { 
        ...
        background: linear-gradient(rgba(15, 23, 42, 0.75), rgba(15, 23, 42, 0.5)), url('https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&q=80&w=1920');
        background-size: cover; 
        background-position: center; 
        border-bottom: 1px solid var(--about-border);
        color: white;
      }
      .hero-editorial-content-v3 h1 { color: white !important; }
      .hero-lead { color: rgba(255, 255, 255, 0.8) !important; }
      .metric-number { color: var(--secondary) !important; }
      .metric-label { color: rgba(255, 255, 255, 0.6) !important; }
      .hero-editorial-content-v3 { max-width: 1000px; z-index: 10; }
      .hero-lead { font-size: clamp(1.2rem, 2.5vw, 1.6rem); color: var(--text-muted); max-width: 850px; margin-top: 30px; line-height: 1.7; font-weight: 500; }
      ...
      .metric-number { font-size: 4.2rem; font-weight: 900; line-height: 1; color: var(--primary); }
      .metric-label { font-size: 0.85rem; text-transform: uppercase; letter-spacing: 2px; color: var(--text-muted); font-weight: 800; margin-top: 10px; }
      .metric-divider { width: 1px; height: 60px; background: var(--glass-border); }
      
      .section-title-visionary { font-size: clamp(2.5rem, 5.5vw, 4.2rem); font-weight: 900; letter-spacing: -2px; line-height: 1.1; color: var(--text-main); }
      .mt-120 { margin-top: 120px; }
      .mb-80 { margin-bottom: 80px; }
      .mb-100 { margin-bottom: 100px; }

      /* FOUNDER V3 (CINEMATIC DARK) */
      .founder-cinematic { background: #0f172a; color: white; position: relative; overflow: hidden; }
      .founder-cinematic .section-title-visionary { color: white; }
      .founder-cinematic .text-muted-standard { color: rgba(255,255,255,0.7) !important; }
      .founder-cinematic .vision-list-v3 li { color: rgba(255,255,255,0.8); }
      ...
      .img-visionary-founder { width: 100%; height: 600px; object-fit: cover; border-radius: 40px; border: 1px solid var(--about-border); box-shadow: var(--shadow-lg); position: relative; z-index: 5; }
      .founder-glow { position: absolute; width: 400px; height: 400px; background: radial-gradient(circle, rgba(0, 209, 193, 0.08) 0%, transparent 70%); top: -50px; right: -50px; z-index: 1; }
      .floating-quote-v3 { position: absolute; bottom: -20px; left: -120px; z-index: 10; width: 360px; padding: 40px; background: white; border: 1px solid var(--about-border); border-radius: 30px; box-shadow: var(--shadow-xl); }
      .floating-quote-v3 i { font-size: 2.5rem; margin-bottom: 20px; color: var(--secondary); }
      .floating-quote-v3 p { font-style: italic; font-size: 1.15rem; line-height: 1.7; margin-bottom: 25px; color: var(--text-main); font-weight: 500; }
      .quote-signature { display: flex; flex-direction: column; }
      .sig-name { font-weight: 900; font-size: 1.15rem; color: var(--primary); }
      .sig-title { font-size: 0.85rem; color: var(--text-muted); letter-spacing: 1px; margin-top: 5px; font-weight: 700; }

      .vision-list-v3 { list-style: none; padding: 0; margin-top: 40px; }
      .vision-list-v3 li { display: flex; align-items: center; gap: 15px; margin-bottom: 20px; font-size: 1.15rem; color: var(--text-muted); font-weight: 500; }
      .v3-bullet { font-size: 1.4rem; color: var(--secondary); }

      /* MISSION MATRIX V3 */
      .mission-bento-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px; }
      .glass-card-v3 { background: white; border: 1px solid var(--about-border); border-radius: 40px; box-shadow: var(--shadow-sm); transition: all 0.4s ease; }
      ...
      .mission-tag { font-size: 0.8rem; font-weight: 900; letter-spacing: 3px; text-transform: uppercase; margin-bottom: 15px; color: var(--secondary); }
      .mission-v3-item h3 { font-size: 2.5rem; font-weight: 900; margin-bottom: 40px; letter-spacing: -1px; color: var(--text-main); }
      .mission-block-v3 { margin-bottom: 30px; }
      .mission-block-v3 h5 { font-size: 0.75rem; letter-spacing: 2px; font-weight: 900; margin-bottom: 8px; color: var(--secondary); }
      .mission-block-v3 p { color: var(--text-muted); line-height: 1.6; font-size: 1.05rem; margin: 0; font-weight: 500; }
      .mission-icon-v3 { font-size: 3rem; color: var(--secondary); position: absolute; top: 50px; right: 50px; opacity: 0.1; }
      
      .group-medical { border-color: var(--about-border); }
      .group-organic { border-color: var(--about-border); }
      .group-medical:hover, .group-organic:hover { border-color: var(--secondary); transform: translateY(-5px); box-shadow: var(--shadow-md); }

      /* MASTER TIMELINE V3 */
      .master-timeline-v3 { position: relative; max-width: 900px; margin: 0 auto; padding-left: 80px; }
      .master-timeline-v3::before { content: ''; position: absolute; left: 20px; top: 0; width: 1px; height: 100%; background: linear-gradient(to bottom, var(--secondary), var(--about-border)); }
      .timeline-v3-item { position: relative; margin-bottom: 60px; }
      .timeline-v3-dot-container { position: absolute; left: -67px; top: 15px; }
      .timeline-v3-dot { width: 14px; height: 14px; border-radius: 50%; background: var(--secondary); border: 4px solid white; position: relative; z-index: 10; box-shadow: 0 0 15px rgba(0, 209, 193, 0.4); }
      .timeline-v3-pulse { position: absolute; top: -14px; left: -14px; width: 42px; height: 42px; border: 2px solid var(--secondary); border-radius: 50%; animation: pulseTimeline 3s infinite; opacity: 0; }
      @keyframes pulseTimeline { 0% { transform: scale(0.4); opacity: 0.6; } 100% { transform: scale(1.4); opacity: 0; } }
      .timeline-v3-content { padding: 45px; position: relative; }
      .timeline-v3-date { font-size: 0.8rem; font-weight: 900; letter-spacing: 3px; text-transform: uppercase; margin-bottom: 12px; color: var(--secondary); }
      .timeline-v3-content h3 { font-size: 1.8rem; margin-bottom: 15px; font-weight: 900; color: var(--text-main); }
      .timeline-v3-content p { color: var(--text-muted); line-height: 1.7; font-size: 1.1rem; margin: 0; font-weight: 500; }

      /* TEAM V3 - RESTORED PORTRAITS */
      ...
      .team-portrait-wrapper-v3 { width: 100%; height: 420px; overflow: hidden; position: relative; border-bottom: 1px solid var(--about-border); background: #f8fafc; }
      .img-portrait-v3 { width: 100%; height: 100%; object-fit: cover; filter: grayscale(1); transition: all 0.8s cubic-bezier(0.165, 0.84, 0.44, 1); opacity: 0.8; }
      .team-card-v3:hover .img-portrait-v3 { filter: grayscale(0); transform: scale(1.08); opacity: 1; }
      .team-content-v3 { padding: 40px 30px; }
      .team-title-v3 { font-size: 0.85rem; font-weight: 900; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 15px; color: var(--secondary); }
      .team-content-v3 h3 { font-size: 1.6rem; font-weight: 900; color: var(--text-main); margin-bottom: 10px; }
      ...
      .value-item i { font-size: 2rem; margin-bottom: 15px; color: var(--secondary); }
      .value-item h4 { font-size: 1.1rem; margin-bottom: 10px; font-weight: 900; color: var(--text-main); }
      .value-item p { font-size: 0.85rem; color: var(--text-muted); line-height: 1.5; font-weight: 600; }
      .value-item:hover { border-color: var(--secondary); transform: translateY(-5px); box-shadow: var(--shadow-md); }
      ...
      .client-icon-glow { font-size: 3rem; color: var(--secondary); margin-bottom: 25px; }
      .client-card-v3 h4 { font-size: 1.05rem; font-weight: 900; color: var(--text-main); line-height: 1.4; }
      .client-card-v3:hover { transform: translateY(-10px); border-color: var(--secondary); background: rgba(0, 209, 193, 0.03); box-shadow: var(--shadow-md); }

      /* VALUES ICON CIRCLE */
      .value-icon-circle { width: 80px; height: 80px; margin: 0 auto 25px; background: rgba(0, 209, 193, 0.05); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 2.2rem; color: var(--secondary); border: 1px solid rgba(0, 209, 193, 0.1); }

      /* BUTTONS */
      .btn-visionary { padding: 18px 40px; font-weight: 900; border-radius: 18px; font-size: 1.05rem; display: inline-flex; align-items: center; transition: all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1); }
      .btn-primary { background: var(--primary); color: white; border: none; }
      .btn-primary:hover { background: var(--primary-dark); transform: translateY(-5px); box-shadow: var(--shadow-lg); }

      /* RESPONSIVE */
      @media (max-width: 1100px) {
        .hero-editorial-v3 { padding: 150px 20px 80px; height: auto; min-height: auto; }
        ...
        .floating-quote-v3 { position: relative; bottom: 0; left: 0; width: calc(100% - 40px); margin: -80px auto 30px; padding: 35px; text-align: left; }
        .mission-bento-grid { grid-template-columns: 1fr; }
        .mission-v3-item { height: auto; min-height: 450px; }
        .values-grid-v3 { grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); }
        .clients-grid-v3 { grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); }
      }
      @media (max-width: 768px), (max-height: 600px) {
        .hero-editorial-v3 { padding-top: 150px !important; }
        .section-title-visionary { font-size: 2.8rem; text-align: center; }
        .hero-lead { text-align: center; }
        .hero-metrics-v3 { justify-content: center; }
